...
func (_UniswapV2Pool *UniswapV2PoolCaller) Allowance(opts *bind.CallOpts, owner common.Address, spender common.Address) (*big.Int, error) {
	var out []interface{}
	err := _UniswapV2Pool.contract.Call(opts, &out, "allowance", owner, spender)
...
//
// Solidity: function allowance(address owner, address spender) view returns(uint256)
func (_UniswapV2Pool *UniswapV2PoolSession) Allowance(owner common.Address, spender common.Address) (*big.Int, error) {
	return _UniswapV2Pool.Contract.Allowance(&_UniswapV2Pool.CallOpts, owner, spender)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(address owner, address spender) view returns(uint256)
func (_UniswapV2Pool *UniswapV2PoolCallerSession) Allowance(owner common.Address, spender common.Address) (*big.Int, error) {
	return _UniswapV2Pool.Contract.Allowance(&_UniswapV2Pool.CallOpts, owner, spender)
}
...
func (_UniswapV2Pool *UniswapV2PoolCaller) BalanceOf(opts *bind.CallOpts, owner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _UniswapV2Pool.contract.Call(opts, &out, "balanceOf", owner)
...
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (_UniswapV2Pool *UniswapV2PoolSession) BalanceOf(owner common.Address) (*big.Int, error) {
	return _UniswapV2Pool.Contract.BalanceOf(&_UniswapV2Pool.CallOpts, owner)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (_UniswapV2Pool *UniswapV2PoolCallerSession) BalanceOf(owner common.Address) (*big.Int, error) {
	return _UniswapV2Pool.Contract.BalanceOf(&_UniswapV2Pool.CallOpts, owner)
}
...
func (_UniswapV2Pool *UniswapV2PoolCaller) Nonces(opts *bind.CallOpts, owner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _UniswapV2Pool.contract.Call(opts, &out, "nonces", owner)
...
//
// Solidity: function nonces(address owner) view returns(uint256)
func (_UniswapV2Pool *UniswapV2PoolSession) Nonces(owner common.Address) (*big.Int, error) {
	return _UniswapV2Pool.Contract.Nonces(&_UniswapV2Pool.CallOpts, owner)
}

// Nonces is a free data retrieval call binding the contract method 0x7ecebe00.
//
// Solidity: function nonces(address owner) view returns(uint256)
func (_UniswapV2Pool *UniswapV2PoolCallerSession) Nonces(owner common.Address) (*big.Int, error) {
	return _UniswapV2Pool.Contract.Nonces(&_UniswapV2Pool.CallOpts, owner)
}
...
func (_UniswapV2Pool *UniswapV2PoolTransactor) Initialize(opts *bind.TransactOpts, arg0 common.Address, arg1 common.Address) (*types.Transaction, error) {
	return _UniswapV2Pool.contract.Transact(opts, "initialize", arg0, arg1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address , address ) returns()
func (_UniswapV2Pool *UniswapV2PoolSession) Initialize(arg0 common.Address, arg1 common.Address) (*types.Transaction, error) {
	return _UniswapV2Pool.Contract.Initialize(&_UniswapV2Pool.TransactOpts, arg0, arg1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address , address ) returns()
func (_UniswapV2Pool *UniswapV2PoolTransactorSession) Initialize(arg0 common.Address, arg1 common.Address) (*types.Transaction, error) {
	return _UniswapV2Pool.Contract.Initialize(&_UniswapV2Pool.TransactOpts, arg0, arg1)
}
